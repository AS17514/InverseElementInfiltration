...
namespace TheLaw.Data
{
    ...
    /// <summary>攻击模板：方向 + 射程 + 伤害 + 友伤（攻击参数全部由模板决定，可编辑）。</summary>
    [Serializable]
    public class AttackTemplate : Template
    {
        public Direction direction = Direction.Up; // 攻击方向（前/后/左右）
        ...
        public AttackTemplate(Direction direction, int range, int damage, bool friendlyFire = true)
        {
